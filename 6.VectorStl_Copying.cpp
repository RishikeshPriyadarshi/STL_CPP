//Hm ek vector bananan chate hai jiske anadar
// "a" copy kr lu
...
int main() {
  ...
  vector<int> last(a);//Last vector of "a" is created
                      //Basically all the elements of a r there

                      //Hmne 'a' ke saare vector last me daal diye
